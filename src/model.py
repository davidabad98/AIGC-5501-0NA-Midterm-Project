...
class classificationModel:
    ...
    def __init__(self):
        ...
        self.vector_filename = "tfidf_vectorizer.pkl"
    ...
    def question_classification_model(self):   
        ...
        save_model_and_metric(model,vectorizer,accuracy,report,self.model_folder_path, self.model_filename,self.vector_filename, self.metric_filename)
